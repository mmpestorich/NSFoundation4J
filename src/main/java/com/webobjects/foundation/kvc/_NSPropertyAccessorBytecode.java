package com.webobjects.foundation.kvc;
...
import com.webobjects.foundation.kvc.NSKeyValueCoding._KeyBinding;
import com.webobjects.foundation.kvc._KeyBindingCreation._KeyBindingFactory;
import com.webobjects.foundation.kvc._KeyBindingCreation._KeyBindingFactory._BindingStorage;
import com.webobjects.foundation.utilities._NSStringUtilities;
import com.webobjects.foundation.utilities._NSUtilities;

public class _NSPropertyAccessorBytecode {
  ...
  public _NSPropertyAccessorBytecode(Object object) {
    targetObject = object;
  ...
  public static _KeyBinding _createKeyBindingForKey(Object object, String key, int lookupOrder[], boolean trueForSetAndFalseForGet) {
    _KeyBinding keyBinding = new _NSPropertyAccessorBytecode(object)._createKeyBindingForKey(key, lookupOrder, trueForSetAndFalseForGet);
